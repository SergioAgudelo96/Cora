...
import { Activity, FileText, History, Home, LogOut } from "lucide-react"
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-1 container px-4 py-6">
        <section className="mb-8">
          ...
          <p className="text-gray-600 mb-4">
            Access all your ECG analysis tools and patient records from this central dashboard.
          </p>
      ...
      <footer className="sticky bottom-0 border-t bg-white">
        <div className="container flex items-center justify-between h-16 px-4">
          <Link href="/dashboard" className="flex flex-col items-center text-red-500">
